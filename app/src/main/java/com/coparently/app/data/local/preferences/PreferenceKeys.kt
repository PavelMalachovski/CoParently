...
object PreferenceKeys {
     ...
     * while the next change — a different instant — is announced again. A value left by a build
     * that stored an ISO string here does not parse and reads as "nothing dismissed".
     */
